...
var Engine = (function(global) {
    ...
    function main() {
         ...
         * a boolean variable is provided to stop the game when it ends.
         * if it ends, then a small rectangle appears to announce game status.
         */
    ...
    function renderWindow() {
        ctx.fillStyle = 'white';
        ctx.fillRect(107, 213, 291, 180);
        ctx.lineWidth = 5;
        ctx.strokeStyle = 'grey';
        ctx.strokeRect(107, 213, 291, 180);
        ctx.font = '36px serif';
        ctx.textAlign = 'center';
        ctx.fillStyle = 'grey';
        ctx.fillText("You Won!", canvas.width/2, 305);
        ctx.font = '18px serif';
        ctx.textAlign = 'center';
